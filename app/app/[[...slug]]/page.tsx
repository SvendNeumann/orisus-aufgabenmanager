...
function ChecklistList({ checks, title, empty }: { checks: any[]; title: string; empty: string }) {
...
function ChecklistDetail({ detail }: { detail: any }) {
